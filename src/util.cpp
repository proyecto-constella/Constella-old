...
const char * const BITCOIN_CONF_FILENAME = "constella.conf";
const char * const BITCOIN_PID_FILENAME = "constellad.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "constella";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/constella";
#else
    // Unix
    return pathRet / ".constella";
#endif
#endif
}
