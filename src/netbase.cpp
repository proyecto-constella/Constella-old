...
enum SOCKS5Reply: uint8_t {
    ...
    NETUNREAXCLBLE = 0x03,   //! Network unreachable
    HOSTUNREAXCLBLE = 0x04,  //! Network unreachable
...
std::string Socks5ErrorString(uint8_t err)
{
    switch(err) {
        ...
        case SOCKS5Reply::NETUNREAXCLBLE:
            return "network unreachable";
        case SOCKS5Reply::HOSTUNREAXCLBLE:
...
std::string NetworkErrorString(int err)
{
    ...
    const char *s;
#ifdef STRERROR_R_XCLR_P /* GNU variant can return a pointer outside the passed buffer */
