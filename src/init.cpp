...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/proyecto-constella/constellawallet>";
    const std::string URL_WEBSITE = "<https://constella.cl>";
...
bool AppInitMain()
{
    ...
    for (const std::string& cmt : gArgs.GetArgs("-uacomment")) {
        if (cmt != SanitizeString(cmt, SAFE_XCLRS_UA_COMMENT))
