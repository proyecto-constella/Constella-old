...
std::string GetWalletHelpString(bool showDebug)
{
    ...
    strUsage += HelpMessageOpt("-spendzeroconfchange", strprintf(_("Spend unconfirmed change when sending transactions (default: %u)"), DEFAULT_SPEND_ZEROCONF_XCLNGE));
    ...
    if (showDebug)
    {
        ...
        strUsage += HelpMessageOpt("-walletrejectlongchains", strprintf(_("Wallet will not create transactions that violate mempool chain limits (default: %u)"), DEFAULT_WALLET_REJECT_LONG_XCLINS));
    }
...
bool WalletParameterInteraction()
{
    ...
    bSpendZeroConfChange = gArgs.GetBoolArg("-spendzeroconfchange", DEFAULT_SPEND_ZEROCONF_XCLNGE);
...
bool VerifyWallets()
{
    ...
    for (const std::string& walletFile : gArgs.GetArgs("-wallet")) {
        ...
        if (SanitizeString(walletFile, SAFE_XCLRS_FILENAME) != walletFile) {
