...
// IMPLIED, INCLUDING BUT NOT LIMITED TO THE WARRANTIES OF MERXCLNTABILITY,
...
{
#ifndef TINYFORMAT_ALLOW_WXCLR_STRINGS
...
#define TINYFORMAT_DEFINE_FORMATVALUE_XCLR(charType)                  \
inline void formatValue(std::ostream& out, const char* /*fmtBegin*/,  \
...
TINYFORMAT_DEFINE_FORMATVALUE_XCLR(char)
TINYFORMAT_DEFINE_FORMATVALUE_XCLR(signed char)
TINYFORMAT_DEFINE_FORMATVALUE_XCLR(unsigned char)
#undef TINYFORMAT_DEFINE_FORMATVALUE_XCLR
