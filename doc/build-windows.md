...
Below are some notes on how to build ConstellaWallet for Windows.

The options known to work for building ConstellaWallet on Windows are:

* On Linux using the [Mingw-w64](https://mingw-w64.org/doku.php) cross compiler tool chain. Ubuntu Bionic 18.04 is required
and is the platform used to build the ConstellaWallet Windows release binaries.
...
Note that for WSL the ConstellaWallet source path MUST be somewhere in the default mount file system, for
