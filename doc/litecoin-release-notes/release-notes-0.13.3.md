ConstellaWallet version 0.13.3 is now available from:
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/proyecto-constella/constellawalletblob/0.13/src/chainparams.cpp#L214).
