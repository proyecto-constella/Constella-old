...
Setup
-----
Unpack the files into a directory and run constellawallet.exe.

ConstellaWallet is the original Litecoin client and it builds the backbone of the network.
