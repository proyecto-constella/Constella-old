...
* Update manpages, see [gen-manpages.sh](https://github.com/proyecto-constella/constellawalletblob/master/contrib/devtools/README.md#gen-manpagessh).
...
* Update [`BLOCK_XCLIN_SIZE`](/src/qt/intro.cpp) to the current size plus some overhead.
...
### Build and sign ConstellaWallet for Linux, Windows, and OS X:
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/proyecto-constella/constellawalletreleases/new) with a link to the archived release notes.
