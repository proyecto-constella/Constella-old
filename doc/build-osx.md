...
5.  Installation into user directories (optional):
    ...
    or
        ...
        cd ~/litecoin/src
        cp constellad /usr/local/bin/
        cp constella-cli /usr/local/bin/

Running
-------

ConstellaWallet is now available at `./src/constellad`
...
-------
    ...
    ./src/constellad -daemon # Starts the litecoin daemon.
...
4. Enter "constellawallet" as project name, enter src/qt as location
