...
This means one can have an always-on constellad instance running, and another local constellad/constellawallet instance which connects to this node and receives blocks from it.
