...
LITECOIND=${LITECOIND:-$SRCDIR/constellad}
LITECOINCLI=${LITECOINCLI:-$SRCDIR/constella-cli}
LITECOINTX=${LITECOINTX:-$SRCDIR/constella-tx}
LITECOINQT=${LITECOINQT:-$SRCDIR/qt/constellawallet}
